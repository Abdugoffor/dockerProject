                    ...
                    @foreach ($sameOrders as $sameOrder)
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="order_product_images{{ $sameOrder->model_product->id }}{{ $sameOrder->id }}" class="modal fade" tabindex="-1">
                            ...
                            <td>
                                @if (Auth::user()->hasPermissionTo('order_app.create'))
                                    <a type="button" class="btn btn-light mb-2" data-toggle="modal"
                                        data-target="#modal_default{{ $sameOrder->id }}">Производство
                                        {{-- <span class="btn btn-primary rounded-pill btn-icon btn-sm ml-2" style="font-weight: 900;font-size: 12pt;">{{ $sameOrder->count }}</span> --}}
                                        <span class="badge badge-primary"
                                            style="font-weight: 900;font-size: 12pt;">{{ $sameOrder->count }}</span>
                                    </a>
                                @endif
                                <!-- Basic modal -->
